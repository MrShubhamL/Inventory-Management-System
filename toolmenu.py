...
class Sales(QMainWindow,ui):
    ...
    def update_quantity(self):
        ...
        try:
            self.cur.execute(f"UPDATE add_products SET Qty = Qty-{qty_a}")
            self.db.commit()
            self.db.close()
        except:
    ...
    def search(self):
        ...
        if artical_no == "":
            ...
            try:   
                ...
                # self.lineEdit_3.setText(data[9])
...
class Purchase(QMainWindow,pi):
    ...
    def add_products(self):
        ...
        if Purchase_Bill == "":
            ...
            try:
                data1 = (Purchase_Bill,Supp_Bill,Barcode,Product_Name,Artical_No,MRP,Sale_Rate,Rate,Net_Amount,Quantity,Packing,Storage,Date,Discont,GST,
                ...
                # buttonreplay2 = QMessageBox.information(self,"Sorry!",f"Last purchase bill number:{Purchase_Bill}")
...
class Serial_Number(QMainWindow,serial):
    ...
    def login(self):
        ...
        if password == "51631720181161210006" and username == "shubhamlohar":
            print('user match')
            self.statusBar().showMessage('You Are Successfull Login')
            self.groupBox.setEnabled(True)
...
class Stock_Manager(QMainWindow,Stock_Manage):
    ...
    def search(self):
        ...
        Supplier_bill_No = self.lineEdit_16.text()
